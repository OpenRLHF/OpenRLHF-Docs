...
- **PPO Implementation Optimization**: To enhance training stability, we have integrated various implementation tricks for PPO, details in `Zhihu <https://zhuanlan.zhihu.com/p/622134699>`_ and  the `Notion AI blog <https://hijkzzz.notion.site/rlhf-implementation-tricks?v=158d9a33ecc98132bf9e000c39227361&pvs=74>`_.
